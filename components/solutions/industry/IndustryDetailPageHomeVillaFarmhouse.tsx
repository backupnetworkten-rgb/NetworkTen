...
import type { IndustryData, IndustryProduct } from "@/data/industries/types";
...
/**
 * Home | Villa | Farmhouse only uses this subset of the shared
 * IndustryProduct["icon"] union (see @/data/industries/types).
 *
 * Note: FenceRoundedIcon is a newer MUI icon — if your installed
 * @mui/icons-material version doesn't have it, swap for SecurityRoundedIcon.
 */
type HomeVillaFarmhouseProductIcon =
  | "camera"
  | "fire"
  | "wifi"
  | "boundarywall"
...
const productIconMap: Record<HomeVillaFarmhouseProductIcon, React.ReactNode> = {
  camera: <VideocamRoundedIcon />,
  fire: <LocalFireDepartmentRoundedIcon />,
  wifi: <WifiRoundedIcon />,
  boundarywall: <FenceRoundedIcon />,
  mobilebooster: <SignalCellularAltRoundedIcon />,
  videodoorphone: <DoorbellRoundedIcon />,
  homeautomation: <SettingsRemoteRoundedIcon />,
  intrusion: <ReportProblemRoundedIcon />,
  hometheatre: <TheatersRoundedIcon />,
  lockers: <LockOpenRoundedIcon />,
};
...
export default function IndustryDetailPageHomeVillaFarmhouse({ data }: Props) {
  return (
    <Box component="main">
      <Hero data={data} />
      <Stats data={data} />
    ...
    <Box sx={{ py: { xs: 6, md: 9 }, background: "#fff" }}>
      <Container maxWidth="xl">
        <SectionHeading
          ...
          description="Security and infrastructure gaps in homes, villas and farmhouses show up in specific places. Here's where we focus."
        />
    ...
    <Box sx={{ py: { xs: 6, md: 9 }, background: "linear-gradient(to bottom, #f6faff, #ffffff)" }}>
      <Container maxWidth="xl">
        <SectionHeading
          ...
          description="Every property gets its own mix — this is the full toolkit we draw from."
        />
        ...
        >
          {data.products.map((p) => (
            ...
            >
              ...
              >
                {productIconMap[(p as IndustryProduct).icon as HomeVillaFarmhouseProductIcon]}
              </Box>
              <Box>
    ...
    <Box sx={{ py: { xs: 6, md: 9 }, background: "#fff" }}>
      <Container maxWidth="xl">
        <SectionHeading
          ...
          description="The same four steps whether it's a full-time residence or a weekend farmhouse."
        />
        ...
        >
          <Box>
            <Typography sx={{ color: "#fff", fontWeight: 900, fontSize: { xs: "20px", md: "26px" }, mb: 1, lineHeight: 1.25 }}>
              Ready to secure your {data.title.toLowerCase()}?
            </Typography>
            <Typography sx={{ color: "rgba(255,255,255,0.68)", fontSize: "13px", maxWidth: 480, lineHeight: 1.65 }}>
              Tell us about your property — we'll come back with a plan and a quote.
            </Typography>
          </Box>
