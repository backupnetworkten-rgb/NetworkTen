...
import type { IndustryData } from "@/data/industries/education";
...
export default function IndustryDetailPageEducation({ data }: Props) {
  return (
    <Box component="main">
      <Hero data={data} />
      <Stats data={data} />
    ...
    <Box sx={{ py: { xs: 6, md: 9 }, background: "#fff" }}>
      <Container maxWidth="xl">
        <SectionHeading
          ...
          description="Security and infrastructure gaps in education show up in specific places. Here's where we focus."
        />
    ...
    <Box sx={{ py: { xs: 6, md: 9 }, background: "linear-gradient(to bottom, #f6faff, #ffffff)" }}>
      <Container maxWidth="xl">
        <SectionHeading
          ...
          description="Every campus gets its own mix — this is the full toolkit we draw from."
        />
    ...
    <Box sx={{ py: { xs: 6, md: 9 }, background: "#fff" }}>
      <Container maxWidth="xl">
        <SectionHeading
          ...
          title="From campus visit to support line"
          description="The same four steps whether it's a single campus or a multi-campus institution."
        />
        ...
        >
          <Box>
            <Typography sx={{ color: "#fff", fontWeight: 900, fontSize: { xs: "20px", md: "26px" }, mb: 1, lineHeight: 1.25 }}>
              Ready to equip your {data.title.toLowerCase()} campus?
            </Typography>
            <Typography sx={{ color: "rgba(255,255,255,0.68)", fontSize: "13px", maxWidth: 480, lineHeight: 1.65 }}>
              Tell us how many buildings or buses you're working with — we'll come back with a plan and a quote.
            </Typography>
          </Box>
