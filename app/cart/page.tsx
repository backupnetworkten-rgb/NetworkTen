        ...
        {[
          ...
          <Box key={i} sx={{ display: "flex", alignItems: "center", gap: 0.9, mr: 3.5 }}>
            <Box sx={{
              ...
              boxShadow: s.active ? "0 2px 6px rgba(0,0,0,0.2)" : "none",
            }}>
              <Typography sx={{ fontSize: "10px", fontWeight: 700, color: s.active ? "#fff" : C.textMuted, fontFamily: sans }}>
                {i + 1}
              </Typography>
            </Box>
            <Typography sx={{ fontSize: "12.5px", fontWeight: 600, fontFamily: sans, color: s.active ? C.heading : C.textMuted, letterSpacing: "-0.1px" }}>
              {s.label}
            </Typography>
          ...
          <Box sx={{
            ...
            <Box>
              <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 1.8, px: 0.5 }}>
                <Typography sx={{ fontSize: "16px", fontWeight: 800, color: C.heading, fontFamily: sans, letterSpacing: "-0.3px" }}>
                  Your Items
                </Typography>
                <Button
                  ...
                  return (
                    <Box
                      ...
                      sx={{
                        ...
                        "&:hover": { boxShadow: "0 6px 28px rgba(0,0,0,0.09)", borderColor: C.heading },
                      }}
                    >
                      {/* Image panel */}
                      <Box
                      ...
                      >
                        ...
                        <img src={proxyImage(item.image)} alt={item.name} style={{ width: 86, height: 86, objectFit: "contain" }} />
                      </Box>
                      {/* Info panel */}
                      <Box sx={{ flex: 1, minWidth: 0, p: { xs: "16px 18px", md: "20px 24px" }, display: "flex", flexDirection: "column" }}>
                        <Typography sx={{ fontSize: "9.5px", fontWeight: 700, color: C.blue, textTransform: "uppercase", letterSpacing: "1px", mb: 0.6, fontFamily: sans }}>
                          {item.brand}
                        </Typography>
                        ...
                        <Typography
                          ...
                          sx={{
                            ...
                            color: C.heading, lineHeight: 1.45, mb: 1.4, cursor: "pointer",
                            "&:hover": { color: C.blue },
                          ...
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1.8 }}>
                            ...
                            <IconButton
                              ...
                              sx={{
                                ...
                                borderRadius: "10px", width: 32, height: 32, background: C.surface,
              ...
              <Box sx={{ ...sectionSx, mt: 2.5 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1.2, px: "24px", py: "18px", borderBottom: `1px solid ${C.borderLight}`, background: C.surfaceWarm }}>
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: { xs: "repeat(2,1fr)", sm: "repeat(4,1fr)" }, p: "20px 22px", gap: 1.6 }}>
                  {TRUST.map((t, i) => (
            ...
            <Box sx={{ position: { md: "sticky" }, top: { md: 20 }, alignSelf: "flex-start", width: "100%" }}>
              ...
              {/* Coupon card */}
              <Box sx={{ ...sectionSx, p: "20px 22px", mb: 2.5 }}>
                ...
                {applied ? (
                  <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: C.greenLight, border: `1px solid ${C.greenBorder}`, borderRadius: "9px", px: 1.5, py: 1 }}>
              ...
              {/* Order summary card */}
              <Box sx={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: "16px", overflow: "hidden", boxShadow: "0 1px 2px rgba(0,0,0,0.03), 0 10px 30px rgba(0,0,0,0.07)" }}>

                <Box sx={{
                  background: "linear-gradient(135deg, #1e3a8a 0%, #1d4ed8 60%, #2563eb 100%)",
                  px: 2.5, py: 2.2, display: "flex", alignItems: "center", gap: 1.2,
                }}>
                  <Box sx={{
